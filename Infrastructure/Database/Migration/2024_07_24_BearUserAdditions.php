...
return new class extends Migration {
    public function up(): void {
        Schema::table(table: 'bear_user', callback: function (Blueprint $table) {
            ...
            $table->foreign('map_location_marker_enum')->references('enum')->on(table: 'map_marker');
    ...
    public function down(): void {
        Schema::table(table: 'bear_user', callback: function (Blueprint $table) {
            ...
            $table->dropForeign('bear_user_map_location_marker_enum_foreign');
            ...
            $table->dropColumn('map_location_marker_enum');

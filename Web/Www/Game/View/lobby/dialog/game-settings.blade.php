...
<x-bear::dialog.update hx-patch="/game/{{$game->id}}/lobby/settings">
  <x-bear::form.number id="number_of_rounds" required min="1" max="40"  class="@if($game->templated_by_game_id === null) hidden @endif"  >{{$game->number_of_rounds}}</x-bear::form.number>

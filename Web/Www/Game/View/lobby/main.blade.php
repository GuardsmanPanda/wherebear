...
<x-panel class="m-2">
    <div class="flex flex-col w-full">
        <div class="flex gap-2">
            ...
            <img class="h-8 ml-auto rounded border border-shade-border-default shadow" src="https://devfuntime.gman.bot/static/flag/svg/{{ $user->cca2 }}.svg"
    ...
    <div class="flex flex-col w-full gap-4">
        ...
        @if ($isPlayerHost)
            <div class="flex items-end gap-4 pb-4 border-b border-shade-border-light">
                ...
                <x-button label="Configure" :type="ButtonType::SECONDARY" :style="ButtonStyle::WARNING" :size="ButtonSize::SM" hx-get="/game/{{$game->id}}/lobby/dialog/settings"
                          class="w-full"/>

  ...
  <x-slot:heading>
    ...
    <div class="flex flex-col w-full gap-4">
      <div class="flex justify-between gap-4 border-b-0 border-shade-border-light">
        <div class="flex items-center h-8  border border-shade-border-light rounded">
        ...
        <div class="flex h-8 gap-1 bg-tertiary-surface-light border border-shade-border-light rounded overflow-hidden">
          ...
          <div class="flex justify-between items-center cursor-pointer p-1" onclick="copyGameJoinLinkToClipboard()">
            <x-icon icon="clipboard" :isButton=true class="hover:text-shade-text-title" />
          </div>
        </div>
      </div>

...
<div class="flex justify-self-end justify-between items-center relative w-full h-8 sm:h-12 rounded sm:rounded-none px-2 bg-iris-200 border sm:border-0 sm:border-t border-iris-700">

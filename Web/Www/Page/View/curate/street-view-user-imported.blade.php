...
<div class="flex">
  ...
  <div id="tags" class="mt-1 ml-12">
    ...
    <div class="flex gap-4 ml-2 items-center">
      ...
      @endif
      <div class="flex items-center">
        <label class="mr-2 font-medium text-gray-400" for="LANDMARK">LANDMARK</label>
        <input id="LANDMARK" type="checkbox" name="tag" value="LANDMARK">
      </div>
      <div class="flex items-center">
    ...
    <tr class="border-b bg-gray-800 border-gray-700">
      ...
      <td class="px-4 py-2">
        <button type="button"
                ...
                onclick="window.open('https://www.google.com/maps/{{'@' . $panorama->lat}},{{$panorama->lng}},0a,73.7y,90t/data=!3m4!1e1!3m2!1s{{$panorama->id}}!2e10', 'sv', 'popup')">
          Open Street View
        </button>
        <button type="button"
                ...
                onclick="window.open('/panorama/{{$panorama->panorama_id}}/view', 'pano', 'popup')">Open Local View
        </button>
      </td>
    </tr>
  @endforeach

...
Route::prefix('discovery')->middleware([BearPermissionMiddleware::using(permission: 'panorama::contribute')])->group(callback: function () {
...
Route::prefix('download')->middleware([BearPermissionMiddleware::using(permission: 'panorama::download')])->group(callback: function () {

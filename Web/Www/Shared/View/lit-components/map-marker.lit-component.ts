      ...
      <div class="flex flex-col items-center font-body">
        <div class="flex flex-col items-center">
          ...
          ${this.playerName
            ? html`
                <div
                  class="w-3 h-10 absolute top-[40px] bg-gray-100 border border-gray-700"
                  style="box-shadow: inset 1px 0 2px rgba(0, 0, 0, 0.3);"
                ></div>
                ...
                >
                  ...
                  <svg
                    class="shrink-0 relative bottom-px left-px"
                    width="24"
                    height="24"
                    viewBox="0 0 32 32"
                    fill="none"
                  ...
                  >
                    <path
                      d="M15.2353 0.5H14.9094L14.7778 0.79818L1.54254 30.7982L1.23291 31.5H2H28C30.4853 31.5 32.5 29.4853 32.5 27V5C32.5 2.51472 30.4853 0.5 28 0.5H15.2353Z"
                      fill="${this.rightCornerHexaColor}"
                      stroke="#333847"
                    />
                  </svg>
                </div>
